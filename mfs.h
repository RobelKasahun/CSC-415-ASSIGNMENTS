...
typedef struct
	...
	DIR *directoryPointer;  		/* Pointer to the loaded directory you want to iterate */
...
fdDir * getEntryLocation(char * pathname);//gets entry location at pathname
